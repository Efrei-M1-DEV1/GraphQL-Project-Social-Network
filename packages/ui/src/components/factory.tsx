...
type ForwardRefExoticComponent<Component extends React.ElementType, Props extends object = object> = {
  <AsComponent extends React.ElementType = "div">(
    props: MergeWithAs<PropsOf<Component>, PropsOf<AsComponent>, Props, AsComponent>,
  ): React.ReactNode;
  displayName?: string;
};
 ...
 */
export type UixComponent<E extends React.ElementType, P extends object = object> = ForwardRefExoticComponent<
  E,
  Assign<PolymorphicProps, P>
>;

/**
 * Props for components, allowing the use of a different element type or child element.
 */
export type UixPropsWithRef<E extends React.ElementType, P extends object = object> = Assign<
  PropsOf<E>,
  Assign<PolymorphicProps, P>
>;
